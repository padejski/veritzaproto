...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'core_familymember', (
            ...
            ('public_official', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.PublicOfficial'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('relationship', self.gf('django.db.models.fields.CharField')(max_length=40)),
        ))
        db.send_create_signal(u'core', ['FamilyMember'])

        # Adding model 'FamilyMemberCompany'
        db.create_table(u'core_familymembercompany', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('uuid', self.gf('django.db.models.fields.CharField')(max_length=36, blank=True)),
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.User'], null=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ...
            ('active', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('is_ok', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True)),
            ('member', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.FamilyMember'])),
            ('company', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Company'])),
        ))
        db.send_create_signal(u'core', ['FamilyMemberCompany'])


    def backwards(self, orm):
        # Deleting model 'FamilyMember'
        db.delete_table(u'core_familymember')

        # Deleting model 'FamilyMemberCompany'
        db.delete_table(u'core_familymembercompany')
