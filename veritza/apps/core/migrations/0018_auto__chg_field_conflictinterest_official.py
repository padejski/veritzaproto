...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ConflictInterest.official'
        db.alter_column(u'core_conflictinterest', 'official_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.PublicOfficial']))

    def backwards(self, orm):

        # Changing field 'ConflictInterest.official'
        db.alter_column(u'core_conflictinterest', 'official_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.PublicOfficialReport']))
