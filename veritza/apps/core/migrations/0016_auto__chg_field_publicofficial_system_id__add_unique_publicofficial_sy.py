...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PublicOfficial.system_id'
        db.alter_column(u'core_publicofficial', 'system_id', self.gf('django.db.models.fields.CharField')(max_length=255, unique=True, null=True))
        # Adding unique constraint on 'PublicOfficial', fields ['system_id']
        db.create_unique(u'core_publicofficial', ['system_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'PublicOfficial', fields ['system_id']
        db.delete_unique(u'core_publicofficial', ['system_id'])


        # Changing field 'PublicOfficial.system_id'
        db.alter_column(u'core_publicofficial', 'system_id', self.gf('django.db.models.fields.CharField')(default=None, max_length=255))
