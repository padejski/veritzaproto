...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ContractingAuthority.email'
        db.alter_column(u'core_contractingauthority', 'email', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

    def backwards(self, orm):

        # Changing field 'ContractingAuthority.email'
        db.alter_column(u'core_contractingauthority', 'email', self.gf('django.db.models.fields.EmailField')(max_length=75, null=True))
