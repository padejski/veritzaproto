...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ContractingAuthority.is_ok'
        db.add_column(u'core_contractingauthority', 'is_ok',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Company.is_ok'
        db.add_column(u'core_company', 'is_ok',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Person.is_ok'
        db.add_column(u'core_person', 'is_ok',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'PublicProcurement.is_ok'
        db.add_column(u'core_publicprocurement', 'is_ok',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'ElectionsContributions.is_ok'
        db.add_column(u'core_electionscontributions', 'is_ok',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'PublicOfficialReport.is_ok'
        db.add_column(u'core_publicofficialreport', 'is_ok',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'CompanyMember.is_ok'
        db.add_column(u'core_companymember', 'is_ok',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'CompanyMemberTitle.is_ok'
        db.add_column(u'core_companymembertitle', 'is_ok',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'BidderCompany.is_ok'
        db.add_column(u'core_biddercompany', 'is_ok',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Veritza.is_ok'
        db.add_column(u'core_veritza', 'is_ok',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'ProcurementCompanyRaw.is_ok'
        db.add_column(u'core_procurementcompanyraw', 'is_ok',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'PublicOfficial.is_ok'
        db.add_column(u'core_publicofficial', 'is_ok',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'ProcurementCompany.is_ok'
        db.add_column(u'core_procurementcompany', 'is_ok',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Dataset.is_ok'
        db.add_column(u'core_dataset', 'is_ok',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ContractingAuthority.is_ok'
        db.delete_column(u'core_contractingauthority', 'is_ok')

        # Deleting field 'Company.is_ok'
        db.delete_column(u'core_company', 'is_ok')

        # Deleting field 'Person.is_ok'
        db.delete_column(u'core_person', 'is_ok')

        # Deleting field 'PublicProcurement.is_ok'
        db.delete_column(u'core_publicprocurement', 'is_ok')

        # Deleting field 'ElectionsContributions.is_ok'
        db.delete_column(u'core_electionscontributions', 'is_ok')

        # Deleting field 'PublicOfficialReport.is_ok'
        db.delete_column(u'core_publicofficialreport', 'is_ok')

        # Deleting field 'CompanyMember.is_ok'
        db.delete_column(u'core_companymember', 'is_ok')

        # Deleting field 'CompanyMemberTitle.is_ok'
        db.delete_column(u'core_companymembertitle', 'is_ok')

        # Deleting field 'BidderCompany.is_ok'
        db.delete_column(u'core_biddercompany', 'is_ok')

        # Deleting field 'Veritza.is_ok'
        db.delete_column(u'core_veritza', 'is_ok')

        # Deleting field 'ProcurementCompanyRaw.is_ok'
        db.delete_column(u'core_procurementcompanyraw', 'is_ok')

        # Deleting field 'PublicOfficial.is_ok'
        db.delete_column(u'core_publicofficial', 'is_ok')

        # Deleting field 'ProcurementCompany.is_ok'
        db.delete_column(u'core_procurementcompany', 'is_ok')

        # Deleting field 'Dataset.is_ok'
        db.delete_column(u'core_dataset', 'is_ok')
