...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'ContractingAuthority', fields ['identification_number']
        db.create_index(u'core_contractingauthority', ['identification_number'])

        # Adding index on 'Company', fields ['identification_number']
        db.create_index(u'core_company', ['identification_number'])

        # Adding index on 'Company', fields ['registration_number']
        db.create_index(u'core_company', ['registration_number'])

        # Adding index on 'PublicOfficialReport', fields ['name']
        db.create_index(u'core_publicofficialreport', ['name'])

        # Adding index on 'CompanyMember', fields ['company_registration_number']
        db.create_index(u'core_companymember', ['company_registration_number'])

        # Adding index on 'BidderCompany', fields ['identification_number']
        db.create_index(u'core_biddercompany', ['identification_number'])

        # Adding index on 'BidderCompany', fields ['procurement_number']
        db.create_index(u'core_biddercompany', ['procurement_number'])


    def backwards(self, orm):
        # Removing index on 'BidderCompany', fields ['procurement_number']
        db.delete_index(u'core_biddercompany', ['procurement_number'])

        # Removing index on 'BidderCompany', fields ['identification_number']
        db.delete_index(u'core_biddercompany', ['identification_number'])

        # Removing index on 'CompanyMember', fields ['company_registration_number']
        db.delete_index(u'core_companymember', ['company_registration_number'])

        # Removing index on 'PublicOfficialReport', fields ['name']
        db.delete_index(u'core_publicofficialreport', ['name'])

        # Removing index on 'Company', fields ['registration_number']
        db.delete_index(u'core_company', ['registration_number'])

        # Removing index on 'Company', fields ['identification_number']
        db.delete_index(u'core_company', ['identification_number'])

        # Removing index on 'ContractingAuthority', fields ['identification_number']
        db.delete_index(u'core_contractingauthority', ['identification_number'])
