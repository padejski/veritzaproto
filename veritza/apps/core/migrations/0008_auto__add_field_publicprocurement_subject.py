...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PublicProcurement.subject'
        db.add_column(u'core_publicprocurement', 'subject',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PublicProcurement.subject'
        db.delete_column(u'core_publicprocurement', 'subject')
