...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'CompanyMemberTitle.last_name'
        db.delete_column(u'core_companymembertitle', 'last_name')

        # Deleting field 'CompanyMemberTitle.link'
        db.delete_column(u'core_companymembertitle', 'link')

        # Deleting field 'CompanyMemberTitle.first_name'
        db.delete_column(u'core_companymembertitle', 'first_name')

        # Adding field 'CompanyMemberTitle.company_member'
        db.add_column(u'core_companymembertitle', 'company_member',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.CompanyMember'], null=True),
                      keep_default=False)

        # Deleting field 'CompanyMember.title'
        db.delete_column(u'core_companymember', 'title')
    ...
    def backwards(self, orm):
        # Adding field 'CompanyMemberTitle.last_name'
        db.add_column(u'core_companymembertitle', 'last_name',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True),
                      keep_default=False)

        # Adding field 'CompanyMemberTitle.link'
        db.add_column(u'core_companymembertitle', 'link',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True),
                      keep_default=False)

        # Adding field 'CompanyMemberTitle.first_name'
        db.add_column(u'core_companymembertitle', 'first_name',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True),
                      keep_default=False)

        # Deleting field 'CompanyMemberTitle.company_member'
        db.delete_column(u'core_companymembertitle', 'company_member_id')

        # Adding field 'CompanyMember.title'
        db.add_column(u'core_companymember', 'title',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True),
                      keep_default=False)
    ...
    models = {
        ...
        u'core.conflictinterest': {
            'Meta': {'unique_together': "(('official', 'company', 'public_procurement'),)", 'object_name': 'ConflictInterest'},
