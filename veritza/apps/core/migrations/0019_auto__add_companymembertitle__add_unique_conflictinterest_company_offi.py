...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'ConflictInterest', fields ['company', 'official', 'public_procurement']
        db.create_unique(u'core_conflictinterest', ['company_id', 'official_id', 'public_procurement_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'ConflictInterest', fields ['company', 'official', 'public_procurement']
        db.delete_unique(u'core_conflictinterest', ['company_id', 'official_id', 'public_procurement_id'])
