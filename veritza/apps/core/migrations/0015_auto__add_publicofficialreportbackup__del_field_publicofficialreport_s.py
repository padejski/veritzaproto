...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PublicOfficialReportBackup'
        db.create_table(u'core_publicofficialreportbackup', (
        ...
        db.send_create_signal(u'core', ['PublicOfficialReportBackup'])

        # Deleting field 'PublicOfficialReport.spouse_salary'
        db.delete_column(u'core_publicofficialreport', 'spouse_salary')

        # Adding field 'PublicOfficialReport.company_board_member'
        db.add_column(u'core_publicofficialreport', 'company_board_member',
                      self.gf('django.db.models.fields.CharField')(max_length=1024, null=True),
                      keep_default=False)

        # Adding field 'PublicOfficialReport.other_activities'
        db.add_column(u'core_publicofficialreport', 'other_activities',
                      self.gf('django.db.models.fields.CharField')(max_length=1024, null=True),
                      keep_default=False)

        # Adding field 'PublicOfficialReport.other_activities_salary'
        db.add_column(u'core_publicofficialreport', 'other_activities_salary',
                      self.gf('django.db.models.fields.CharField')(max_length=1024, null=True),
                      keep_default=False)

        # Adding field 'PublicOfficialReport.movables_others'
        db.add_column(u'core_publicofficialreport', 'movables_others',
                      self.gf('django.db.models.fields.CharField')(max_length=1024, null=True),
                      keep_default=False)

        # Adding field 'PublicOfficialReport.company_salary'
        db.add_column(u'core_publicofficialreport', 'company_salary',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True),
                      keep_default=False)

        # Adding field 'PublicOfficialReport.annual_income'
        db.add_column(u'core_publicofficialreport', 'annual_income',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True),
                      keep_default=False)

        # Adding field 'PublicOfficialReport.other_income'
        db.add_column(u'core_publicofficialreport', 'other_income',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True),
                      keep_default=False)

        # Adding field 'PublicOfficialReport.credits_debts'
        db.add_column(u'core_publicofficialreport', 'credits_debts',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True),
                      keep_default=False)

        # Adding field 'PublicOfficialReport.spouse_other_activities'
        db.add_column(u'core_publicofficialreport', 'spouse_other_activities',
                      self.gf('django.db.models.fields.CharField')(max_length=1024, null=True),
                      keep_default=False)

        # Adding field 'PublicOfficialReport.spouse_movables_others'
        db.add_column(u'core_publicofficialreport', 'spouse_movables_others',
                      self.gf('django.db.models.fields.CharField')(max_length=1024, null=True),
                      keep_default=False)

        # Adding field 'PublicOfficialReport.spouse_company_salary'
        db.add_column(u'core_publicofficialreport', 'spouse_company_salary',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True),
                      keep_default=False)

        # Adding field 'PublicOfficialReport.spouse_annual_income'
        db.add_column(u'core_publicofficialreport', 'spouse_annual_income',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True),
                      keep_default=False)

        # Adding field 'PublicOfficialReport.spouse_other_income'
        db.add_column(u'core_publicofficialreport', 'spouse_other_income',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True),
                      keep_default=False)

        # Adding field 'PublicOfficialReport.spouse_credits_debts'
        db.add_column(u'core_publicofficialreport', 'spouse_credits_debts',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True),
                      keep_default=False)


        # Changing field 'PublicOfficialReport.real_estate'
        db.alter_column(u'core_publicofficialreport', 'real_estate', self.gf('django.db.models.fields.CharField')(max_length=1024, null=True))

        # Changing field 'PublicOfficialReport.movables'
        db.alter_column(u'core_publicofficialreport', 'movables', self.gf('django.db.models.fields.CharField')(max_length=1024, null=True))

        # Changing field 'PublicOfficialReport.companies'
        db.alter_column(u'core_publicofficialreport', 'companies', self.gf('django.db.models.fields.CharField')(max_length=1024, null=True))

    def backwards(self, orm):
        # Deleting model 'PublicOfficialReportBackup'
        db.delete_table(u'core_publicofficialreportbackup')

        # Adding field 'PublicOfficialReport.spouse_salary'
        db.add_column(u'core_publicofficialreport', 'spouse_salary',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True),
                      keep_default=False)

        # Deleting field 'PublicOfficialReport.company_board_member'
        db.delete_column(u'core_publicofficialreport', 'company_board_member')

        # Deleting field 'PublicOfficialReport.other_activities'
        db.delete_column(u'core_publicofficialreport', 'other_activities')

        # Deleting field 'PublicOfficialReport.other_activities_salary'
        db.delete_column(u'core_publicofficialreport', 'other_activities_salary')

        # Deleting field 'PublicOfficialReport.movables_others'
        db.delete_column(u'core_publicofficialreport', 'movables_others')

        # Deleting field 'PublicOfficialReport.company_salary'
        db.delete_column(u'core_publicofficialreport', 'company_salary')

        # Deleting field 'PublicOfficialReport.annual_income'
        db.delete_column(u'core_publicofficialreport', 'annual_income')

        # Deleting field 'PublicOfficialReport.other_income'
        db.delete_column(u'core_publicofficialreport', 'other_income')

        # Deleting field 'PublicOfficialReport.credits_debts'
        db.delete_column(u'core_publicofficialreport', 'credits_debts')

        # Deleting field 'PublicOfficialReport.spouse_other_activities'
        db.delete_column(u'core_publicofficialreport', 'spouse_other_activities')

        # Deleting field 'PublicOfficialReport.spouse_movables_others'
        db.delete_column(u'core_publicofficialreport', 'spouse_movables_others')

        # Deleting field 'PublicOfficialReport.spouse_company_salary'
        db.delete_column(u'core_publicofficialreport', 'spouse_company_salary')

        # Deleting field 'PublicOfficialReport.spouse_annual_income'
        db.delete_column(u'core_publicofficialreport', 'spouse_annual_income')

        # Deleting field 'PublicOfficialReport.spouse_other_income'
        db.delete_column(u'core_publicofficialreport', 'spouse_other_income')

        # Deleting field 'PublicOfficialReport.spouse_credits_debts'
        db.delete_column(u'core_publicofficialreport', 'spouse_credits_debts')


        # Changing field 'PublicOfficialReport.real_estate'
        db.alter_column(u'core_publicofficialreport', 'real_estate', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'PublicOfficialReport.movables'
        db.alter_column(u'core_publicofficialreport', 'movables', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'PublicOfficialReport.companies'
        db.alter_column(u'core_publicofficialreport', 'companies', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))
    ...
    models = {
        ...
        u'core.publicofficialreportbackup': {
            'Meta': {'object_name': 'PublicOfficialReportBackup'},
            'active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['core.User']", 'null': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
