...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding index on 'PublicOfficialReport', fields ['system_id']
        db.create_index(u'core_publicofficialreport', ['system_id'])


    def backwards(self, orm):
        # Removing index on 'PublicOfficialReport', fields ['system_id']
        db.delete_index(u'core_publicofficialreport', ['system_id'])
