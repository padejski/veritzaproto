...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PublicProcurement.value'
        db.alter_column(u'core_publicprocurement', 'value', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=2))

    def backwards(self, orm):

        # Changing field 'PublicProcurement.value'
        db.alter_column(u'core_publicprocurement', 'value', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))
    ...
    models = {
        ...
        u'core.publicprocurement': {
            ...
            'value_d': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '10', 'decimal_places': '2'})
        },
        u'core.tag': {
