...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'BidderCompany', fields ['identification_number']
        db.delete_unique(u'core_biddercompany', ['identification_number'])


    def backwards(self, orm):
        # Adding unique constraint on 'BidderCompany', fields ['identification_number']
        db.create_unique(u'core_biddercompany', ['identification_number'])
    ...
    models = {
        ...
        u'core.biddercompany': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'identification_number': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
