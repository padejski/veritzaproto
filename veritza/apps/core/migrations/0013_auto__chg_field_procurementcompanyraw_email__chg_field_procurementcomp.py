...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ProcurementCompanyRaw.email'
        db.alter_column(u'core_procurementcompanyraw', 'email', self.gf('django.db.models.fields.EmailField')(max_length=255, null=True))

        # Changing field 'ProcurementCompany.email'
        db.alter_column(u'core_procurementcompany', 'email', self.gf('django.db.models.fields.EmailField')(max_length=255, null=True))

    def backwards(self, orm):

        # Changing field 'ProcurementCompanyRaw.email'
        db.alter_column(u'core_procurementcompanyraw', 'email', self.gf('django.db.models.fields.EmailField')(max_length=75, null=True))

        # Changing field 'ProcurementCompany.email'
        db.alter_column(u'core_procurementcompany', 'email', self.gf('django.db.models.fields.EmailField')(max_length=75, null=True))
