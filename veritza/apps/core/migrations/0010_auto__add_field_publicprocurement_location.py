...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PublicProcurement.location'
        db.add_column(u'core_publicprocurement', 'location',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PublicProcurement.location'
        db.delete_column(u'core_publicprocurement', 'location')
