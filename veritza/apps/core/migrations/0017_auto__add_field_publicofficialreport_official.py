...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PublicOfficialReport.official'
        db.add_column(u'core_publicofficialreport', 'official',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.PublicOfficial'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PublicOfficialReport.official'
        db.delete_column(u'core_publicofficialreport', 'official_id')
