...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ContractingAuthority.procurement_number'
        db.add_column(u'core_contractingauthority', 'procurement_number',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)

        # Deleting field 'PublicProcurement.authority'
        db.delete_column(u'core_publicprocurement', 'authority_id')

        # Deleting field 'PublicProcurement.bidder'
        db.delete_column(u'core_publicprocurement', 'bidder_id')

        # Adding field 'PublicProcurement.system_id'
        db.add_column(u'core_publicprocurement', 'system_id',
                      self.gf('django.db.models.fields.CharField')(max_length=40, null=True),
                      keep_default=False)

        # Adding field 'PublicProcurement.link'
        db.add_column(u'core_publicprocurement', 'link',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'CompanyMember.company_share'
        db.add_column(u'core_companymember', 'company_share',
                      self.gf('django.db.models.fields.CharField')(max_length=30, null=True),
                      keep_default=False)

        # Adding field 'BidderCompany.procurement_number'
        db.add_column(u'core_biddercompany', 'procurement_number',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ContractingAuthority.procurement_number'
        db.delete_column(u'core_contractingauthority', 'procurement_number')

        # Adding field 'PublicProcurement.authority'
        db.add_column(u'core_publicprocurement', 'authority',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.ContractingAuthority'], null=True),
                      keep_default=False)

        # Adding field 'PublicProcurement.bidder'
        db.add_column(u'core_publicprocurement', 'bidder',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.BidderCompany'], null=True),
                      keep_default=False)

        # Deleting field 'PublicProcurement.system_id'
        db.delete_column(u'core_publicprocurement', 'system_id')

        # Deleting field 'PublicProcurement.link'
        db.delete_column(u'core_publicprocurement', 'link')

        # Deleting field 'CompanyMember.company_share'
        db.delete_column(u'core_companymember', 'company_share')

        # Deleting field 'BidderCompany.procurement_number'
        db.delete_column(u'core_biddercompany', 'procurement_number')
    ...
    models = {
        ...
        u'core.company': {
            ...
            'registration_number': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True'}),
        ...
        u'core.companymember': {
            ...
            'active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'company_registration_number': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
