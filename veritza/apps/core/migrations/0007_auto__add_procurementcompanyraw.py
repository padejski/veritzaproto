...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ProcurementCompanyRaw'
        db.create_table(u'core_procurementcompanyraw', (
        ...
        db.send_create_signal(u'core', ['ProcurementCompanyRaw'])


    def backwards(self, orm):
        # Deleting model 'ProcurementCompanyRaw'
        db.delete_table(u'core_procurementcompanyraw')
