...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ElectionsContributionCompanyMember'
        db.create_table(u'core_electionscontributioncompanymember', (
            ...
            ('company_member', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.CompanyMember'])),
            ('company', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Company'], null=True, blank=True)),
            ('election_contribution', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.ElectionsContributions'])),
        ))
        db.send_create_signal(u'core', ['ElectionsContributionCompanyMember'])


    def backwards(self, orm):
        # Deleting model 'ElectionsContributionCompanyMember'
        db.delete_table(u'core_electionscontributioncompanymember')
    ...
    models = {
        ...
        u'core.electionscontributioncompanymember': {
            'Meta': {'object_name': 'ElectionsContributionCompanyMember'},
            'active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'company': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['core.Company']", 'null': 'True', 'blank': 'True'}),
            'company_member': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['core.CompanyMember']"}),
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['core.User']", 'null': 'True'}),
            'election_contribution': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['core.ElectionsContributions']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
