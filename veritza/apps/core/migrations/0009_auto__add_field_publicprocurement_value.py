...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PublicProcurement.value'
        db.add_column(u'core_publicprocurement', 'value',
                      self.gf('django.db.models.fields.CharField')(max_length=20, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PublicProcurement.value'
        db.delete_column(u'core_publicprocurement', 'value')
