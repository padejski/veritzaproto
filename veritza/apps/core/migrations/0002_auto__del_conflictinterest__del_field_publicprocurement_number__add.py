...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'PublicProcurement.number'
        db.delete_column(u'core_publicprocurement', 'number')

        # Adding field 'PublicProcurement.number'
        db.add_column(u'core_publicprocurement', 'number',
                      self.gf('django.db.models.fields.CharField')(max_length=40, null=True),
                      keep_default=False)

        # Adding field 'PublicOfficialReport.spouse'
        db.add_column(u'core_publicofficialreport', 'spouse',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'PublicOfficialReport.spouse'
        db.delete_column(u'core_publicofficialreport', 'spouse')
