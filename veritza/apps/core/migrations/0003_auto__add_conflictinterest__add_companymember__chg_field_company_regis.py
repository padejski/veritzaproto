...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Company', fields ['registration_number']
        db.delete_unique(u'core_company', ['registration_number'])
        ...
        db.create_table(u'core_companymember', (
            ...
            ('company_registration_number', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ...
        # Changing field 'Company.registration_number'
        db.alter_column(u'core_company', 'registration_number', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Company.registration_number'
        db.alter_column(u'core_company', 'registration_number', self.gf('django.db.models.fields.CharField')(default='', max_length=255, unique=True))
        # Adding unique constraint on 'Company', fields ['registration_number']
        db.create_unique(u'core_company', ['registration_number'])
