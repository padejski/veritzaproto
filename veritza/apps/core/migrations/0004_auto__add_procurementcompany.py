...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ProcurementCompany'
        db.create_table(u'core_procurementcompany', (
        ...
        db.send_create_signal(u'core', ['ProcurementCompany'])


    def backwards(self, orm):
        # Deleting model 'ProcurementCompany'
        db.delete_table(u'core_procurementcompany')
