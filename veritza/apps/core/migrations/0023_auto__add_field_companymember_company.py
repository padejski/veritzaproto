...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CompanyMember.company'
        db.add_column(u'core_companymember', 'company',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Company'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CompanyMember.company'
        db.delete_column(u'core_companymember', 'company_id')
