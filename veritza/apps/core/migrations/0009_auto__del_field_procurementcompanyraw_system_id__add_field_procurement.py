...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ProcurementCompanyRaw.system_id'
        db.delete_column(u'core_procurementcompanyraw', 'system_id')

        # Adding field 'ProcurementCompanyRaw.procurement_system_id'
        db.add_column(u'core_procurementcompanyraw', 'procurement_system_id',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=20, db_index=True),
                      keep_default=False)

        # Deleting field 'ProcurementCompany.system_id'
        db.delete_column(u'core_procurementcompany', 'system_id')

        # Adding field 'ProcurementCompany.procurement_system_id'
        db.add_column(u'core_procurementcompany', 'procurement_system_id',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=20, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'ProcurementCompanyRaw.system_id'
        db.add_column(u'core_procurementcompanyraw', 'system_id',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=20, db_index=True),
                      keep_default=False)

        # Deleting field 'ProcurementCompanyRaw.procurement_system_id'
        db.delete_column(u'core_procurementcompanyraw', 'procurement_system_id')

        # Adding field 'ProcurementCompany.system_id'
        db.add_column(u'core_procurementcompany', 'system_id',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=20, db_index=True),
                      keep_default=False)

        # Deleting field 'ProcurementCompany.procurement_system_id'
        db.delete_column(u'core_procurementcompany', 'procurement_system_id')
    ...
    models = {
        ...
        u'core.procurementcompany': {
            ...
            'procurement_system_id': ('django.db.models.fields.CharField', [], {'default': '0', 'max_length': '20', 'db_index': 'True'}),
            'town': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True'}),
            'updated': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'max_length': '36', 'blank': 'True'}),
