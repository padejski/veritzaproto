...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ElectionsContributions.csv_file'
        db.add_column(u'core_electionscontributions', 'csv_file',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ElectionsContributions.csv_file'
        db.delete_column(u'core_electionscontributions', 'csv_file')
    ...
    models = {
        ...
        u'core.electionscontributions': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['core.User']", 'null': 'True'}),
            'csv_file': ('django.db.models.fields.files.FileField', [], {'max_length': '100', 'null': 'True'}),
