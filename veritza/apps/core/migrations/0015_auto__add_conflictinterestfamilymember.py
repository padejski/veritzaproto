...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ConflictInterestFamilyMember'
        db.create_table(u'core_conflictinterestfamilymember', (
        ...
        db.send_create_signal(u'core', ['ConflictInterestFamilyMember'])


    def backwards(self, orm):
        # Deleting model 'ConflictInterestFamilyMember'
        db.delete_table(u'core_conflictinterestfamilymember')
