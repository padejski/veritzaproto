...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ContractingAuthority.procurement_system_id'
        db.add_column(u'core_contractingauthority', 'procurement_system_id',
                      self.gf('django.db.models.fields.CharField')(max_length=40, null=True),
                      keep_default=False)


        # Changing field 'ProcurementCompanyRaw.procurement_system_id'
        db.alter_column(u'core_procurementcompanyraw', 'procurement_system_id', self.gf('django.db.models.fields.CharField')(max_length=40, null=True))
        # Removing index on 'ProcurementCompanyRaw', fields ['procurement_system_id']
        db.delete_index(u'core_procurementcompanyraw', ['procurement_system_id'])


        # Changing field 'ProcurementCompany.procurement_system_id'
        db.alter_column(u'core_procurementcompany', 'procurement_system_id', self.gf('django.db.models.fields.CharField')(max_length=40, null=True))
        # Removing index on 'ProcurementCompany', fields ['procurement_system_id']
        db.delete_index(u'core_procurementcompany', ['procurement_system_id'])


    def backwards(self, orm):
        # Adding index on 'ProcurementCompany', fields ['procurement_system_id']
        db.create_index(u'core_procurementcompany', ['procurement_system_id'])

        # Adding index on 'ProcurementCompanyRaw', fields ['procurement_system_id']
        db.create_index(u'core_procurementcompanyraw', ['procurement_system_id'])

        # Deleting field 'ContractingAuthority.procurement_system_id'
        db.delete_column(u'core_contractingauthority', 'procurement_system_id')


        # Changing field 'ProcurementCompanyRaw.procurement_system_id'
        db.alter_column(u'core_procurementcompanyraw', 'procurement_system_id', self.gf('django.db.models.fields.CharField')(max_length=20))

        # Changing field 'ProcurementCompany.procurement_system_id'
        db.alter_column(u'core_procurementcompany', 'procurement_system_id', self.gf('django.db.models.fields.CharField')(max_length=20))
