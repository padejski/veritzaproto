...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'DummyProfile'
        db.create_table(u'core_dummyprofile', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal(u'core', ['DummyProfile'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'DummyProfile'
        db.delete_table(u'core_dummyprofile')
