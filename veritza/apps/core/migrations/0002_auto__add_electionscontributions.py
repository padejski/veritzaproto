...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ElectionsContributions'
        db.create_table(u'core_electionscontributions', (
            ...
            ('election_type', self.gf('django.db.models.fields.CharField')(max_length=255, null=True)),
            ('election_place', self.gf('django.db.models.fields.CharField')(max_length=40, null=True)),
            ('political_party', self.gf('django.db.models.fields.CharField')(max_length=1024, null=True)),
            ('candidate', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, db_index=True)),
            ('contributor_type', self.gf('django.db.models.fields.CharField')(max_length=255, null=True)),
            ('contributor_name', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, db_index=True)),
            ('contributor_address', self.gf('django.db.models.fields.CharField')(max_length=255, null=True)),
            ('amount', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=2)),
        ))
        db.send_create_signal(u'core', ['ElectionsContributions'])


    def backwards(self, orm):
        # Deleting model 'ElectionsContributions'
        db.delete_table(u'core_electionscontributions')
    ...
    models = {
        ...
        u'core.electionscontributions': {
            ...
            'candidate': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'db_index': 'True'}),
            'contributor_address': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True'}),
            'contributor_name': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'db_index': 'True'}),
            'contributor_type': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['core.User']", 'null': 'True'}),
            'date': ('django.db.models.fields.DateField', [], {'null': 'True'}),
            'election_place': ('django.db.models.fields.CharField', [], {'max_length': '40', 'null': 'True'}),
            'election_type': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'political_party': ('django.db.models.fields.CharField', [], {'max_length': '1024', 'null': 'True'}),
            'updated': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'max_length': '36', 'blank': 'True'})
        },
        u'core.person': {
